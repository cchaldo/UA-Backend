...
/**
 * @api {post} v1/auth/socialSignup SocialSignup
 * @apiDescription Signup a new user using Facebook/Google/LinkedIn etc
 * @apiVersion 1.0.0
 * @apiName SocialSignup
 * @apiGroup SocialSignup
 * @apiPermission public
 *
 * @apiParam  {String}          email     User's email will be taken automatically
 *
 * @apiSuccess (Created 201) {String}  token.tokenType     Access Token's type
 * @apiSuccess (Created 201) {String}  token.accessToken   Authorization Token
 * @apiSuccess (Created 201) {String}  token.refreshToken  Token to get a new accessToken
...
router.route('/socialSignup')
  .post(validate(socialSignup), controller.socialSignup);


/**
 * @api {post} v1/auth/linkedinSignup linkedinSignup
 * @apiDescription Signup a new user using Facebook/Google/LinkedIn etc
 * @apiVersion 1.0.0
 * @apiName linkedinSignup
 * @apiGroup linkedinSignup
 * @apiPermission public
 *
 * @apiParam  {String}          email     User's email will be taken automatically
 *
...
router.route('/linkedinSignup')
  .post(validate(linkedinSignup), controller.linkedinSignup);
